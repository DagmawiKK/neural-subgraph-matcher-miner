...
def main():
    ...
    if args.dataset.endswith('.pkl'):
        ...
        # Import at the top level to avoid scoping issues
        from torch_geometric.datasets import TUDataset as TUDatasetClass
        ...
        try:
            ...
            original_download = TUDatasetClass.download
